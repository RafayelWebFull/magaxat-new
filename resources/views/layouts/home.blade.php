...
<div class="container-xxl">
    <div class="nav-menu">
        <nav class="row navbar-custom navbar-expand-lg navbar-light bg-light">
            <div class="col-md-9 @if(!Auth::user()) col-lg-10 @else col-lg-9 @endif col-sm-8 col-10">
                <div id="navbar-div" class="row">
                    ...
                    <div class="col-md-9 col-lg-12 col-sm-6 col-6" id="navbar">
                        <div class="row">
                            <div class="col-4">
                                <a href="/"><img src="{{asset('images/logo.png')}}" class="col" alt="" id="logo"></a>
                            </div>
                                ...
                                <ul class="nav navbar-nav d-flex">
                                    <li class="li "><a
                                            <?php if (stripos($_SERVER['REQUEST_URI'], 'user-video') !== false) {
                                                echo 'class="active"';
                                            } ?> href="/user-video">User Video</a></li>
                                    <li class=''><a <?php if (stripos($_SERVER['REQUEST_URI'], 'users') !== false) {
                                            echo 'class="active"';
                        ...
                        <div class="dropdown col-6">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <form action="logout" method="POST">
                                    @csrf
                                    <li><a class="dropdown-item" href="#"><button  class="btn" type="submit">Log Out</button></a></li>
                                </form>
                               <button class="btn"><a class="dropdown-item" href="/profile">Profile</a></button>
                            </ul>
                        </div>
                    @endif
